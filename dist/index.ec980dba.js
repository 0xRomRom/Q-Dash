...
})({"a37Ji":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "a7122a9eec980dba";
...
},{}],"4yZjd":[function(require,module,exports) {
"use strict";
...
if (!permission) allowContainer.classList.add("hidden");
...
const intervalFetcher = async ()=>{
    let fetchedPrice = 0;
    while(fetchedPrice < expectedCoinPrice)setInterval(()=>{
        try {
...
//# sourceMappingURL=index.ec980dba.js.map
