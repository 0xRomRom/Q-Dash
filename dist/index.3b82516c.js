...
})({"22jdy":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "32a4b2733b82516c";
...
},{}],"jYW2n":[function(require,module,exports) {
"use strict";
...
const nameChecker = (data)=>{
    for (let value of Object.values(data.coins))if (value.symbol.toLowerCase() === userValueTop || value.name.toLowerCase() === userValueTop) {
...
const nameCheckerBot = (data)=>{
    for (let value of Object.values(data.coins))if (value.symbol.toLowerCase() === userValueBot || value.name.toLowerCase() === userValueBot) {
...
//# sourceMappingURL=index.3b82516c.js.map
