...
const dataFetcher = async (coinName, changeDiv, changeTxt, priceTxt, fixedParam)=>{
    const response = await fetch(`https://api.coingecko.com/api/v3/simple/price?ids=${coinName}&vs_currencies=usd&include_24hr_change=true`);
...
console.log("Data Fetched") // }, 30000)
;
