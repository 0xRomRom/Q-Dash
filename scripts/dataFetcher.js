...
const fetchObject = {
  ...
  60: ["shiba-inu", shibaDiv, shibaChange, shibaPrice, 7],
  61: ["dogelon-mars", dogelonmarsDiv, dogelonmarsChange, dogelonmarsPrice, 7],
  62: ["floki-inu", flokiinuDiv, flokiinuChange, flokiinuPrice, 7],
  63: ["tamadoge", tamadogeDiv, tamadogeChange, tamadogePrice, 7],
  64: ["kishu-inu", kishuinuDiv, kishuinuChange, kishuinuPrice, 2],
  ...
  69: ["cake-monster", cakemonsterDiv, cakemonsterChange, cakemonsterPrice, 7],
  70: ["vita-inu", vitainuDiv, vitainuChange, vitainuPrice, 7],
  71: ["banano", bananoDiv, bananoChange, bananoPrice, 7],
  72: ["the-doge-nft", thedogenftDiv, thedogenftChange, thedogenftPrice, 7],
  73: ["dogebonk", dogebonkDiv, dogebonkChange, dogebonkPrice, 7],
  74: ["polydoge", polydogeDiv, polydogeChange, polydogePrice, 7],
  75: ["cumrocket", cumrocketDiv, cumrocketChange, cumrocketPrice, 7],
  76: ["dogegf", dogegfDiv, dogegfChange, dogegfPrice, 7],
  77: ["woofy", woofyDiv, woofyChange, woofyPrice, 7],
  78: ["dogsofelon", dogsofelonDiv, dogsofelonChange, dogsofelonPrice, 7],
  79: [
    "feisty-doge-nft",
    feistydogenftDiv,
    feistydogenftChange,
