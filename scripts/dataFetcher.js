...
const fetchObject = {
  ...
  60: ["woof-token", woofDiv, woofChange, woofPrice, 7],
  61: ["dogelon-mars", dogelonmarsDiv, dogelonmarsChange, dogelonmarsPrice, 10],
  62: ["floki", flokiinuDiv, flokiinuChange, flokiinuPrice, 9],
  ...
  69: ["hoge-finance", hogefinanceDiv, hogefinanceChange, hogefinancePrice, 8],
  70: ["cake-monster", cakemonsterDiv, cakemonsterChange, cakemonsterPrice, 6],
  ...
  87: ["puli-inu", puliinuDiv, puliinuChange, puliinuPrice, 6],
  ...
  97: ["kittycoin", kittycoinDiv, kittycoinChange, kittycoinPrice, 12],
  98: ["catbonk", catbonkDiv, catbonkChange, catbonkPrice, 12],
  ...
  109: ["shibapup", shibapupDiv, shibapupChange, shibapupPrice, 4],
...
const homeLogo = document.querySelector('.brand-logo-div')
...
togglePage.addEventListener("click", () => {
  ...
  magnifyingGlass.classList.add("colorWhite");
  rotateArrow.classList.add("colorWhite");
